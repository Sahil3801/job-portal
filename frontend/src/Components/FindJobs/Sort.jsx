...
const Sort = (props) => {
  ...
  return (
    ...
    >
      <Combobox.Target>
        <div onClick={() => combobox.toggleDropdown()} className="flex cursor-pointer hover:bg-mine-shaft-900 items-center text-sm xs-mx:text-xs border border-bright-sun-400 rounded-xl py-1 xsm-mx:mt-2 px-2 xs-mx:px-1 xs-mx:py-0 pr-1">
          {selectedItem} 
