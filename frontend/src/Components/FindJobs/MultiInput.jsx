                    ...
                    <Checkbox
                        ...
                        onChange={() => {
                            if (value.includes(item)) {
                                dispatch(updateFilter({ [props.title]: value.filter((v) => v !== item) }));
                            } else {
                                dispatch(updateFilter({ [props.title]: [...value, item] }));
                            }
                        }}
                        aria-hidden
                        tabIndex={-1}
        ...
        <Combobox store={combobox} onOptionSubmit={handleValueSelect} withinPortal={false}>
            <Combobox.DropdownTarget>
                <PillsInput 
                    ...
                    leftSection={
                        <div className="bg-mine-shaft-900 rounded-full mr-2 text-bright-sun-400 p-1">
                            <props.icon size={20} />
                        </div>
                    }
