...
//     return (
//         <Modal opened={props.opened} onClose={props.close} overlayProps={{ backgroundOpacity: 0.55, blur: 3 }} title="Reset Password" centered>
...
//                     rightSection={<Button loading={otpSending && !otpSent} onClick={handleSendOtp} disabled={email === "" || otpSent} className="mr-1" size="xs" autoContrast>Send OTP</Button>}
