        ...
        >
            <div className="flex justify-between">
                <div className="flex gap-2 items-center">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <div className="text-xs text-mine-shaft-300">
                            <Link className="hover:text-mine-shaft-200" to="/company">{props.company}</Link> &bull; {props.applicants ? props.applicants.length : 0} Applicants
                        </div>
                    </div>
                </div>
                {profile.savedJobs?.includes(props.id) ? (
                    ...
                    <IconBookmark
                        onClick={handleSaveJob}
                        className="cursor-pointer text-mine-shaft-300"
                        stroke={1.5}
                    />
                )}
            </div>
            ...
            {props.interviewing && (
                <div className="flex gap-1 text-sm">
                    ...
                    <span className="text-mine-shaft-400">10 AM - 11 AM</span>
                </div>
            )}
