...
const SearchBar = () => {
    ...
    const [value, setValue] = useState([0, 300]);  // Remove the type annotation for value
    ...
    return (
        <div>
            <div className="flex justify-end">
                {matches && <Button onClick={toggle} m="sm" radius="lg" className="align" variant="outline" color="brightSun.4" autoContrast>
